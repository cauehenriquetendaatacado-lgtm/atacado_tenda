...
- **Senha de gerência**: enxerga o resumo e todos os gráficos do dashboard
  ...
  no topo do painel. Não vê o formulário de registro nem consegue abrir a
  lista de ocorrências individuais (loja a loja, com descrição, foto e quem
  registrou) — essas telas ficam restritas ao administrador. O servidor só
  entrega, para essa senha, um resumo sem os campos sensíveis (nome de quem
  registrou, descrição, foto, loja e status de confirmação).
