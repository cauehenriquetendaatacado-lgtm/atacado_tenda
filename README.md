...
- **Senha comum** (funcionários/gerentes): só vê e usa o formulário de
  ...
  pessoas, os painéis por regional/loja, os totais nem nenhum gráfico
  (o servidor também bloqueia a leitura dos registros para essa senha).
- **Senha de administrador**: enxerga tudo isso, vê quem registrou cada
  ...
  **estatística mensal de ocorrências inibidas por regional** (uma
  coluna para cada uma das 4 regionais, uma linha por mês), além dos
  gráficos de ocorrências por regional e de apoio de cópia, quadrilha
  e monitoramento.
